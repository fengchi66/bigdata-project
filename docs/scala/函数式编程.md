...
* [函数类型](#函数类型)
  ...
  * [函数调用](#函数调用)
* [柯里化和闭包](#柯里化和闭包)
  * [函数柯里化(多参数列表)](#函数柯里化多参数列表)
      * [隐式（IMPLICIT）参数](#隐式implicit参数)
  * [闭包](#闭包)
* [高阶函数](#高阶函数)
  * [函数可以作为值进行传递](#函数可以作为值进行传递)
  * [函数可以作为参数进行传递](#函数可以作为参数进行传递)
  * [函数可以作为函数返回值返回](#函数可以作为函数返回值返回)
* [模式匹配](#模式匹配)
  * [语法](#语法)
  * [案例类（case classes）的匹配](#案例类case-classes的匹配)
  * [模式守卫（Pattern gaurds）](#模式守卫pattern-gaurds)
  * [仅匹配类型](#仅匹配类型)
  * [密封类](#密封类)
  * [备注](#备注)
* [偏函数](#偏函数)
